...
if 'Au restaurant' in options :
  ...
  Map.add_markers_from_xy(df_resto, x="longitude", y="latitude", popup=["Nom", "Adresse"], icon_shape = "circle", border_color='black', border_width=1, icon = "", layer_name="Au Restaurant", background_color = "#CCCCFF")
